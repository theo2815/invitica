 ...
 * dashboard rather than about Tala. The reassurance is worth stating plainly here: this
...
export default function AssistantError({ reset }: AssistantErrorProps) {
  return (
    <CreatorRouteError
      description="No invitation, draft, or saved conversation was changed — this page only reads them. Try loading Tala again."
      reset={reset}
      title="Tala could not be loaded."
    />
  );
}
