...
as $$
  select jsonb_build_object(
    ...
    'rendererVersion', case when p_renderer_key = 'little-blessings-v2' then 2 else 1 end,
    'templateVersionId', invitation_drafts.template_version_id,
    'templateVersion', case when p_renderer_key = 'little-blessings-v2' then 2 else 1 end,
...
select throws_ok(
  $reject$select public.request_invitation_publication(
    ...
    pg_temp.snapshot('c2000000-0000-4000-8000-000000000001', 'little-blessings-v2', '[]'::jsonb)
  )$reject$,
...
select throws_ok(
  $reject$select public.request_invitation_publication(
    ...
    pg_temp.snapshot(
      'c2000000-0000-4000-8000-000000000001', 'little-blessings-v2',
      pg_temp.image_manifest('c4000000-0000-4000-8000-000000000001', repeat('ab', 32))
...
select is(
  (select renderer_key || ':' || renderer_version::text from public.publication_versions
    where invitation_id = 'c2000000-0000-4000-8000-000000000001'),
  'little-blessings-v2:2',
  'the stored publication records the v2 key and renderer version rather than hardcoded v1 pins'
);
